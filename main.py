...
def login_page():
    ...
    py_bank_logo.grid(row=0,column=0,rowspan=19,ipady=300)
    ...
    Label(login_frame,text="Don't have an account?",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=8,column=1,sticky='E')
...
def sign_up():
    ...
    py_bank_title.grid(row=0,column=1,pady=(50,0))# places "Py Bank" title on top
    ...
    Label(signup_frame,text="Sign up",font=30,bg='#90cad1',fg=FOREGROUND1).grid(row=1,column=1,pady=(20,50),sticky="W")
    ...
    new_mname.grid(row=4,column=1,pady=20,padx=(0,100))
    ...
    new_email.grid(row=8,column=1,pady=(20,0),padx=(0,100))
    ...
    Label(signup_frame,text='Gender     ',bg='#90cad1',fg=FOREGROUND1).grid(row=12,column=0,pady=(20,0),sticky='E')
    _rowcnt=12
    ...
    new_uname.grid(row=16,column=1,sticky='W',pady=(20,0))
    ...
    new_passwrd.grid(row=18,column=1,padx=(0,100),pady=(20,0))
    ...
    new_cpasswrd.grid(row=20,column=1,pady=(20,0),padx=(0,100))
    
    Button(signup_frame,text='Submit',fg=FOREGROUND1,command=sign_up_data).grid(row=22,column=1,pady=(40,0),padx=(0,100))

    Label(signup_frame,text='OR',bg=BACKGROUND1,fg=FOREGROUND1).grid(row=23, column=1,padx=(0,100),pady=25)
...
def homepage(client:list):
    ...
    py_bank_logo.grid(row=0,column=0,rowspan=19,ipady=200)

    homepage_welcome_label=Label(win,text=f"Welcome {logged_in_name},".title(),font=30,bg=BACKGROUND1,fg=FOREGROUND1)# Welcome message at top.
    ...
    Label(homepage_frame1,text="Account Number",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=0,column=0)

    homepage_frame2=LabelFrame(win,padx=50,pady=10,bg=BACKGROUND1)# Account Number
    homepage_frame2.grid(row=3,column=1,sticky="N")
    Label(homepage_frame2,text=client[9],bg=BACKGROUND1,fg=FOREGROUND1).grid(row=0,column=0)

    homepage_frame3=LabelFrame(win,padx=20,pady=20,bg=BACKGROUND1)
    homepage_frame3.grid(row=2,column=2,sticky="S")
    Label(homepage_frame3,text="Account Balance",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=0,column=0)
    ...
    homepage_balance=Label(homepage_frame4,text=f'Rs. {client[8]}',bg=BACKGROUND1,fg=FOREGROUND1)
    ...
    homepage_frame5.grid(row=5,column=1,padx=50,pady=20,columnspan=2)
    Label(homepage_frame5,text="Quick Fund Transfer",font=20,bg=BACKGROUND1,fg=FOREGROUND1).grid(row=0,column=0,columnspan=2,pady=(0,50))

    Label(homepage_frame5,text="To Account",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=0)# To Account 
    homepage_toaccount=Entry(homepage_frame5)
    homepage_toaccount.grid(row=1,column=1)

    Label(homepage_frame5,text="Account Name",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=3,column=0)# Account name
    homepage_accountname=Entry(homepage_frame5)
    homepage_accountname.grid(row=3,column=1,pady=(20,0))

    Label(homepage_frame5,text="Amount",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=5,column=0)# Amount
    homepage_amount=Entry(homepage_frame5)
    homepage_amount.grid(row=5,column=1,pady=(20,0))

    Label(homepage_frame5,text="Remarks",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=7,column=0)# Remarks
    ...
    Label(homepage_frame6,text="Transactions",font=20,bg=BACKGROUND1,fg=FOREGROUND1).grid(row=0,column=0,columnspan=5,pady=(10,20))

    Label(homepage_frame6,text="Id",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=0)
    Label(homepage_frame6,text="Amount(Rs.)",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=1)
    Label(homepage_frame6,text="Date",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=2)
    Label(homepage_frame6,text="From",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=3)
    Label(homepage_frame6,text="To",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=4)
    Label(homepage_frame6,text="Remarks",bg=BACKGROUND1,fg=FOREGROUND1).grid(row=1,column=5)
    ...
    for i,t in enumerate(filter_transaction):# Takes individual transaction sequentially
        for k,j in enumerate([0,1,2,3,4,6]):
            Label(homepage_frame6,text=t[j],bg=BACKGROUND1,fg=FOREGROUND1).grid(row=i+2,column=k,padx=10,sticky='W')
